...
class AnalyticsManager:
    ...
    def record_conversation_end(self, session_id: str, message_count: int, 
                              satisfaction_score: float = None, converted: bool = False):
    ...
    def record_api_usage(self, api_provider: str, endpoint: str, tokens_used: int,
                        response_time_ms: int, success: bool = True, 
                        error_message: str = None, cost_estimate: float = None):
    ...
    def get_dashboard_metrics(self, hours: int = 24) -> Dict[str, Any]:
        ...
        return {
            ...
            "quality": {
                ...
                "total_errors": sum(row[4] for row in api_usage)
            },
            "api_usage": [
                {
                    "provider": row[0],
