...
class DeepAnalyzer:
    ...
    async def analyze_conversation(
        ...
        try:
            ...
            logger.info(f"✅ Análisis completado: {analysis.primary_emotion.value}, "
                       f"calidad={analysis.conversation_quality_score:.1f}")
...
Responde SOLO con JSON válido, sin explicaciones adicionales."""
    ...
    def _generate_aggregate_report(
        ...
        return {
            ...
            "bot_suspicions": {
                "total": bot_suspicions,
                "percentage": (bot_suspicions / len(analyses)) * 100
            },
            "quality_metrics": {
