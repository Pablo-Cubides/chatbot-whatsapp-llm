...
from src.services.alert_system import alert_manager, AlertManager, AlertSeverity, AlertRuleType
...
class TestAlertSystem:
    ...
    def test_create_alert_manually(self):
        ...
        alert_id = self.alert_manager.create_alert(
            chat_id="chat_manual_123",
            severity=AlertSeverity.MEDIUM,
            message_text="Test manual alert"
        )
    ...
    def test_get_alerts_with_filters(self):
        ...
        alert_id = self.alert_manager.create_alert(
            chat_id="chat_filter_test",
            severity=AlertSeverity.HIGH,
            message_text="Test filter"
        )
    ...
    def test_update_rule(self):
        ...
        # Actualizar
        result = self.alert_manager.update_rule(
            rule_id,
            name="Updated",
            enabled=False
        )
