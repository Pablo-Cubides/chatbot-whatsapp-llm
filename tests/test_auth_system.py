...
from src.services.auth_system import AuthManager, get_current_user, require_admin
...
class TestAuthManager:
    ...
    def test_create_access_token(self):
        ...
        user_data = {"username": "test_user", "role": "admin", "permissions": ["all"]}
    ...
    def test_verify_token_valid(self):
        ...
        user_data = {"username": "test_admin", "role": "admin", "permissions": ["all"]}
    ...
    def test_jwt_secret_too_short_warning(self, caplog):
        ...
        with patch.dict(os.environ, {"JWT_SECRET": "short", "ADMIN_USERNAME": "admin", "ADMIN_PASSWORD": "password123"}):
            AuthManager()
...
class TestAuthDependencies:
    ...
    async def test_require_admin_non_admin(self):
        ...
        non_admin_user = {"username": "operator", "role": "operator", "permissions": ["view"]}
