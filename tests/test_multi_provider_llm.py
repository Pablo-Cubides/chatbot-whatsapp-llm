...
from services.multi_provider_llm import MultiProviderLLM, LLMProvider, APIConfig
...
class TestMultiProviderLLM:
    ...
    async def test_generate_response_all_providers_fail(self):
        ...
        assert 'response' in result  # Should contain fallback response
