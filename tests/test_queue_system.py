...
from src.services.queue_system import queue_manager, QueueManager
...
class TestQueueSystem:
    ...
    def test_get_pending_messages(self):
        ...
        self.queue_manager.enqueue_message("chat1", "Message 1")
        self.queue_manager.enqueue_message("chat2", "Message 2")
    ...
    def test_create_campaign(self):
        """Test crear campaña"""
        campaign_id = self.queue_manager.create_campaign(
            name="Test Campaign",
